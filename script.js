const translations = {
  es: {
    ...
    details: {
      ...
      ceremonyValue: 'La ceremonia religiosa se llevará a cabo a las 5:00 p. m. (hora de México) en la <strong>Basílica Colegiata de Nuestra Señora de Guanajuato, Gto</strong>.',
      photoSessionTitle: 'Sesión de fotos',
      photoSessionValue: 'Después de la ceremonia religiosa, alrededor de las 6:10 p. m., nos reuniremos frente a la iglesia, en: <strong>Plaza de la Paz</strong>, para la sesión de fotos.',
      receptionTitle: 'Recepción',
      receptionValue: 'La recepción se llevará a cabo a las 9:00 p. m. (hora de México) en <strong>La Virgen de la Cueva, Resturante Cultural de Gto.</strong>',
